...
<body class="body-wrapper" style="overflow-y: hidden;">
...
<!-- BANNER SECTION -->
<section class="clearfix homeBanner" style="background-image: url(img/banner/banner1.jpg);height: 750px; ">
	<div class="container">
		<div class="row">
			<div class="col-xs-12">
				<div class="banerInfo">
					<h1>Web Base Advertising Directory<br>
                        Promote Your Business with www.srishops.com</h1>

					<form class="form-inline" action="index-1.php" method="post">
...
<!-- Mirrored from themes.iamabdus.com/listty/1.0/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Jun 2017 07:47:31 GMT -->
</html>
