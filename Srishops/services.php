...
<head>
  ...
  <title>Category list - Listty</title>
			...
			<div class="col-sm-8 col-xs-12 pull-right">
				...
				<div class="listContent">
					<div class="row">
						<div class="col-sm-5 col-xs-12">
							<div class="categoryImage">
								<img src="img/things/things-2.jpg" alt="Image category" class="img-responsive img-rounded">
								<span class="label label-primary">Verified</span>
							</div>
						</div>
						<div class="col-sm-7 col-xs-12">
				...
				<div class="listContent">
					<div class="row">
						<div class="col-sm-5 col-xs-12">
							<div class="categoryImage">
								<img src="img/things/things-3.jpg" alt="Image category" class="img-responsive img-rounded">
								<span class="label label-primary">Verified</span>
							</div>
						</div>
						<div class="col-sm-7 col-xs-12">
          ...
          <div class="row">
            <div class="col-sm-7 col-xs-12">
              <div class="footerText">
                <a href="index-1.php" class="footerLogo"><img src="img/logo-footer.png" alt="Footer Logo"></a>
            ...
            <div class="col-sm-2 col-xs-12">
              ...
              <div class="useLink">
                <ul class="list-unstyled">
                  ...
                  <li><a href="aboutus.php">How It Works</a></li>
...
<!-- Mirrored from themes.iamabdus.com/listty/1.0/category-list-left.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Jun 2017 07:48:40 GMT -->
</html>
